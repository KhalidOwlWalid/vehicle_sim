...
Reference : https://discourse.ros.org/t/spawning-a-robot-entity-using-a-node-with-gazebo-and-ros-2/9985
"""
import os
import sys
import rclpy
...
def main():
    ...
    urdf_file_path = os.path.join(get_package_share_directory('vehicle_sim'), 'models', 'my_robot', 'model.urdf')
